...
public class Constants {
    ...
    // Set to true to start the game maximized/fullscreen
    public static final boolean APPLICATION_START_MAXIMIZED = false;
    
    public static final String CACHE_DIRECTORY = System.getProperty("user.dir") + File.separator + "cache" + File.separator; // Java only

    // Directory for persistent player saves (separate from cache)
    public static final String SAVE_DIRECTORY = System.getProperty("user.dir") + File.separator + "saves" + File.separator;
